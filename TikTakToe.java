...
public class TikTakToe extends Node{
	...
	public static void main(String[] args){
		...
		System.out.print("\n....................\nSelecionou o modo: ");
		if(play==1)
			System.out.println("Modo MiniMax\n....................");
		else
			System.out.println("Alpha-Beta\n....................");
		System.out.print("Deseja começar?\nSim: 1\nNão: 2\n....................\nComeçar: ");
		int start=in.nextInt();
		if(start==1)
			player=1;
		else
			player=2;
		System.out.println("Em cada jogada introduza a posição 'i', seguida da posição 'j'\n....................");
		System.out.println("Utilizador: X\nComputador: O\n");
		...
		if(play==1)
			while(winner==0){
				...
				if(player==1){
					...
					System.out.println("....................\nNúmero de nós expandidos: "+searchedNodes);
				}
				System.out.println("Tempo da jogada: "+(end-s)/1000+"s\n....................");
			}
		else
			while(winner==0){
				searchedNodes=0;
		...
		System.out.println("Número total de nós expandidos: "+totalSearchedNodes);
	}

	static class Play{
		
			/**
			* jogo contra o computador usando o minimax
			 * @param in
			 * @param currentTable
			 */
		public static int playMiniMax(Scanner in,int[][] currentTable,int player){
				if(player!=2){
					...
					if(i>2 || j>2){
						System.out.println("Jogada inválida! Por favor, jogue noutra posição");
						return -1;
					}
		...
		/**
		 * joga contra o computador usando o alpha-beta
		 * @param in
		 * @param currentTable
		 * @param player
		 * @return
		...
		/**
		 * verifica se o jogo terminou, devolve o vencedor
		 * @param currentTable 	tabela
		 * @return 	vencedor (0 se o jogo ainda não terminou; -1 se for empatar)
		 */
		...
		/**
		 * verifica se existe alguma linha cencedora
		 * @param currentTable
		 * @return
		 */
		...
		/**
		 * verifica se existe alguma coluna vencedora
		 * @param currentTable
		 * @return
		 */
		...
		/**
		 * verifica se existe alguma diagonal principal é vencedora	
		 * @param currentTable
		 * @return
		 */
		...
		/**
		 * verifica se existe alguma diagonal secundária é vencedora
		 * @param currentTable
		 * @return
		 */
		...
		/**
		 * verifica se existem mais jogadas possiveis
		 * @param currentTable
		 * @return
		 */
		...
		/*
		 * imprime o vencedor e a jogada vencedora (resultado final)
		 */
		public static void printResult(int[][] currentTable,int winner,int play){
			if(winner==-1)
				...
				if(line!=0)
					System.out.println(" (linha "+linePosition+")");
				else if(column!=0)
					System.out.println(" (coluna "+columnPosition+")");
				else if(diagonal1!=0)
					System.out.println(" (diagonal principal)");
				else
					System.out.println(" (diagonal secundária)");
			}
			System.out.println("Número total de jogadas: "+totalPlays);
		}
